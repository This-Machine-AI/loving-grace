...
When building machines that use subagents, this is a great resource for finding and copying proven configurations:

- **[Awesome Claude Code Subagents](https://github.com/VoltAgent/awesome-claude-code-subagents)** - Collection of 100+ specialized subagents organized by category (core development, language specialists, infrastructure, security, data/AI, and more)
